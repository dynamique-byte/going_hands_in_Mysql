...
--Query1--Find how many customers are there group by category

SELECT Customer_Type, count(Customer_Type) as Total
FROM anra.customer
GROUP BY Customer_Type;

--Query2--Find 2 appartments whose name is emerald or their id is 11003
...
--Query3--Find the supplied product count and their group for each product 
...
--Query4--Total number of orders to be shipped immediate and is partially Shipped
...
--Query5--List of products by department which has high defect%
...
from
 ...
 --Query6--Total amount of revenue earned with respect to their purchasing modes
...
--Query7--Find The quantity of products available whose status is in progress and shipment duration is immediate
